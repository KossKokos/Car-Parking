...
def call_plate_recognizer(
    ...
    """
    Call Plate Recognizer Snapshot API.

    Uses bytes instead of an open file object to avoid multipart encoding issues.
    """
    image_bytes = image_path.read_bytes()

    # For this API, sending a simple string is safer with httpx.
    # For UK plates this will normally be "gb".
    data = {
...
def extract_results(
    ...
    for result in raw_results:
        ...
        required_box_keys = {"xmin", "ymin", "xmax", "ymax"}
        ...
        if dscore is None or score is None:
            continue
